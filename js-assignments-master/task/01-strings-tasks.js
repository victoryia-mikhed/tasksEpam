...
function encodeToRot13(str) {
    ...
    for (var j = 0; j < str.length; j++) {
        if ((str.charCodeAt(j) > 64 && str.charCodeAt(j) < 78) ||
            (str.charCodeAt(j) > 96 && str.charCodeAt(j) < 110)) {
            res += String.fromCharCode(str.charCodeAt(j) + 13);
        } else if ((str.charCodeAt(j) > 77 && str.charCodeAt(j) < 91) ||
            (str.charCodeAt(j) > 109 && str.charCodeAt(j) < 123)) {
            res += String.fromCharCode(str.charCodeAt(j) - 13);
        } else {
            res += str.charAt(j);
        }
